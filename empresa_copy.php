	...
	<body>
		...
		<div class="container">
			...
			<div class="box box-primary content-table">
				...
				<div class="table-responsive-md">
	  				<table id="table-empresas-dos" class="table table-striped table-bordered nowrap" style="width:100%">
						<thead>
				            <tr>
				                <th>Razón Social</th>
				                <th>RUC</th>
		...
		<script type="text/javascript">
			var table = $('#table-usuarios').DataTable({
		        "ajax": 'resources/assets/js/ajax_empresa.json',
		        responsive: true
		    });

		    var tableDos = $('#table-empresa').DataTable( {
		        "processing": true,
		        "serverSide": true,
		        "responsive" : true,
		        "ajax": {
