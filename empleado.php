	...
	if (isset($_POST)) {
		if (count($_POST) > 0) {
			...
			if (isset($_POST["id"]) && $_POST["id"] !="") {
				...
				$empleadosData[$tmpId]["gerencia"] = $_POST["gerencia"];
				$empleadosData[$tmpId]["area"] = $_POST["area"];
				$empleadosData[$tmpId]["puesto"] = $_POST["puesto"];
				$empleadosData[$tmpId]["anio_ingreso"] = (int)$_POST["anio_ingreso"];
				...
				$tmpItem["gerencia"] = $_POST["gerencia"];
				$tmpItem["area"] = $_POST["area"];
				$tmpItem["puesto"] = $_POST["puesto"];
				$tmpItem["anio_ingreso"] = (int)$_POST["anio_ingreso"];
